...
def get_adjacency_matrix(num_joints=23, normalize=True):
    """
...
class PoseGCNTransformer(nn.Module):
    ...
    def __init__(self, num_joints=133, in_channels=3, hidden_dim=512, num_classes=2,
                 num_gcn_layers=5, num_transformer_layers=8, feat_dim=256,num_heads=16):
        super().__init__()
